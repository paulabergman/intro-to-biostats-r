...
# What is the probability of having high cholesterol when a person is a 65-year-old 
...
logit1 <- -1.336758 + 0.037529*60 -0.159780
logit1
...
--- type:NormalExercise lang:r xp:100 skills:1 key: ex4point7
## The odds ratios 1
...
--- type:NormalExercise lang:r xp:100 skills:1 key: ex4point8
## The odds ratios 2
 
We just learned to get odds ratios out of the model results in one way. There is also another, even simpler way and that's ci.exp-function in the Epi package.
 
 
*** =instructions
 - Form a table of the odds ratios and their confidence intervals for model2 using the ci.exp-function.
 - You will have to call the library Epi first.
...
# Form a table of the odds ratios and their confidence intervals for model2
ci.exp(model2) # Do the results match to the ones calculated in the previous exercise?
...
*** =sct
```{r}
test_student_typed("ci.exp", not_typed_msg = "Make sure you used ci.exp-function")
success_msg("Awesome, you now know a good way to form a table of odds ratios and their confidence intervals!")
```



--- type:NormalExercise lang:r xp:100 skills:1 key: ex4point9
