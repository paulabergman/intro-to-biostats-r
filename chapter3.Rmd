...
# Regression coefficient for sex is:
# Regression coefficient for ejection fraction is:
# Intercept for age is:
# Variance explained is:
...
*** =sct
```{r}
test_output_contains("lm(sbp~age+gender+baseEF)", incorrect_msg = "Make sure you have put the variables in the right order, and they are divided by the + sign.")
test_student_typed("summary(", not_typed_msg = "Make sure you have used the summary-function to see the results.")
