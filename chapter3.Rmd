...
*** =hint
Make sure you put your variable inside table, and referred to your variable as data$variale
...
*** =sct
```{r}
test_student_typed("barplot(table(diabetes$gender))", not_typed_msg = "Make sure you used mean()- function.")
test_student_typed("barplot(table(cardiac$gender))", not_typed_msg = "Make sure you used sd()- function.")
