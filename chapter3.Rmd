...
--- type:NormalExercise lang:r xp:100 skills:1 key:exercise3_4
## Comparing the variance explained
 
You've learned a lot about linear regression today! There is still lot to be learned. Next we will compare the varinces explained by our one variable model and our multiple variables model. 
 
*** =instructions
Once again, you can refer to your models with reg1 and reg2.
 - Check the variance explained (adjusted R squared) from both of these models. (You can use summary()-function for example)
 - Which one of these models explains the blood pressure better?
 - Based on the results of your multiple variable model, would you leave out some explanatory variables from the models, and if so, what would you leave out and why? 
 - Do you have idea, what variables could be interesting to add to the model? Why?
*** =hint
...
## Which one is better? Leave the better one here: REG1/REG2

## Which variables you would keep in the model (based on their effect's p-value)? Leave those variable names here: AGE, GENDER, BASEEF
```
...
--- type:NormalExercise lang:r xp:100 skills:1 key:exercise3_5
