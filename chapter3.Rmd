...
test_output_contains("Regression coefficient is: -0.22", test_output_contains = "Make sure you have typed the right regression coefficient.")
test_output_contains("Intercept is: 161.7", incorrect_msg = "Make sure you have typed the right intercept.")
test_output_contains("Variance explained is: 0.00349", incorrect_msg = "Make sure you have typed the right variance explained.")
