...
You can refer to the model you did in the previousexercise by reg3. Check out that model's summary once again. Based on every explanatory variables effects p-value, which variable(s) you would keep in the model ?
*** =instructions
- Age
- Gender
- Bmi
...
test_mc(c(1,2,4), feedback_msgs = c(msg1, msg2, msg3))
