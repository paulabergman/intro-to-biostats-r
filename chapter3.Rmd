...
test_student_typed("pie(cardiac$sbp)", not_typed_msg = "Make sure you used pie()- command. Also make sure you referred to right data set and variable.")
test_student_typed("boxplot(diabetes$age)", not_typed_msg = "Make sure you used pboxlot()- command. Also make sure you referred to right data set and variable.")
