...
test_student_typed("pie(cardiac$sbp)", not_typed_msg = "Make sure you used pie()- command, and put your variable inside table()-command. Also make sure you referred to right data set and variable.")
...
`@hint`
Use command plot() to create your plot. Add title and axis labels to your plot
...
```{r}
# Draw your plot: 
plot(diabetes$sbp, diabetes$maxhr, main = "Example title", ylab = "Maximum heart rate", xlab = "Systolic blood pressure")

```

`@sct`
```{r}
test_student_typed("plot(diabetes$sbp, diabetes$maxhr", not_typed_msg = "Make sure you used plot()- command. Also make sure you referred to right data set and variables.")
test_student_typed("main", not_typed_msg = "Make sure you added the title!")
test_student_typed("ylab" , not_typed_msg = "Make sure you added y label")
test_student_typed("xlab" , not_typed_msg = "Make sure you added x label")
success_msg("Super! It's like there is nothing you can't do with your plotting skills!")
```
---
...
test_student_typed("col", not_typed_msg = "Make sure you added col- argument."")
