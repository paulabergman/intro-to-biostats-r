...
*** =sct
msg1 <- "Perfect! This should have been easy one..."
...
*** =hint
Form the linear model, and checd it's summary.
...
*** =sct
```{r}
test_student_typed("lm(diabetes$ratio~diabetes$age+diabetes$gender+diabetes$bmi+diabetes$waist)", not_typed_msg = "Make sure you used used lm() and put the righ variables inside it in a right order.")
...
success_msg("Great! You're such a master in modelling!")
