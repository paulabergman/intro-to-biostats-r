...
title: Sandbox
description: 'In this chapter, you will learn the basics of how to work on DataCamp and how to handle with exercises.  Since many of you are working with iPads, there will also be some advice regarding special characters such as `^` or `''`. Let''s get started!'
---
