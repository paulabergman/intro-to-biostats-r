...
`@sct`
```{r}
test_output_contains("*", incorrect_msg = "Make sure yours star is an 'upper star'")
test_output_contains("^", incorrect_msg = "Make sure you got '^' sign correctly!")
test_output_contains("#", incorrect_msg = "Make sure you got '#' sign correctly!")
test_output_contains('""', incorrect_msg = "Make sure you got 'straight'  quotation marks!")
test_output_contains("''", incorrect_msg = "Make sure you got 'straight'  quotation marks!")
test_output_contains("$", incorrect_msg = "Make sure you got '$' sign correctly!")
