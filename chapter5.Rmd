...
description: 'In this chapter's exerciser you will learn to check association of continous variables. You will first learn to calculate correlation coefficients, and then linear regression. You will form a few models yourself and train to interpret the results from those models. You will also learn to evaluate the assumptions of the models.'
---
...
In R, correlation coefficient of two variables can be calculated using cor()- function. For that fucntion you give two variables, separated by ','. 
...
`@hint`
Use command cor(). Add correct variables inside that function. Separate your variables by ',' sign.
...
`@instructions`
- Calculate correlation coefficient of variables 'waits' and 'bmi' in diabetes- data set.
