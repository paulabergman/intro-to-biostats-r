...
axis(side = 1, at=1:2, labels=c("male","female")) # this adds text labels instead of 0 and 1
...
# Visualize the systolic blood pressures in males and females in cardiac-dataset
with(cardiac, boxplot(sbp~gender, col="yellow", main="Systolic blood pressure in males and females"))
axis(side = 1, at=1:2, labels=c("male","female")) # this adds text labels instead of 0 and 1
```
