...
*** =instructions
 - Get the Epi-package from the package library. 
 - Print a table of the odds ratios and their confidence intervals for model1. 
 - Draw a plot of odds ratios.
...
# Get the Epi-package by using the library()-command
...
*** =sct
```{r}
test_student_typed("library(Epi)", not_typed_msg = "You have to load the Epi-package before doing anything else.")
test_student_typed("ci.exp(model1)", not_typed_msg = "Make sure you are using the right command for the odds ratio table.")
