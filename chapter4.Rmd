...
axis(side = 1, at=1:2, labels=c("male","female")) # this adds text labels instead of 0 and 1. If you use this, then include command x="xaxt" in your boxplot command!
...
# Visualize the systolic blood pressures in males and females in cardiac-dataset
with(cardiac, boxplot(sbp~gender, col="yellow", main="Systolic blood pressure in males and females", x="xaxt"))
axis(side = 1, at=1:2, labels=c("male","female")) # this adds text labels instead of 0 and 1. If you use this, then include command x="xaxt" in your boxplot command!
```
