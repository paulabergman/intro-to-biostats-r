...
*** =sct
```{r}
test_student_typed("with(cardiac,table(event,restwma))", not_typed_msg = "Make sure you used the right variables.")
test_student_typed("addmargins(table1,FUN=list(Total=sum),quiet=TRUE)", not_typed_msg = "Make sure you used the right variables.")
