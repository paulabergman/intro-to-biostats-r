...
# There is a statistically significant difference, do you agree? (answer AGREE or DISAGREE) 
# Your answer: 
...
test_student_typed("AGREE", not_typed_msg = "Your interpretation of the second t-test needs re-checking. Check whether the confidence interval contains zero or not.")
test_output_contains("X-squared = 34.964", incorrect_msg = "Your chi square value seems to be incorrect. Look at your code carefully, maybe you used a wrong variable?")
test_output_contains("X-squared = 25.346", incorrect_msg = "Your chi square value seems to be incorrect. Look at your code carefully, maybe you used a wrong variable?")
test_output_contains("X-squared = 0.031994", incorrect_msg = "Your chi square value seems to be incorrect. Look at your code carefully, maybe you used a wrong variable?")
