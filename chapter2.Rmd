...
test_student_typed("NO", not_typed_msg = "Your interpretation of the first t-test needs re-checking.")
...
test_student_typed("AGREE", not_typed_msg = "Your interpretation of the second t-test needs re-checking.")
