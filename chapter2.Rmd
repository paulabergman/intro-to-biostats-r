...
*** =sct
```{r}
test_output_contains("barplot(table(diabetes$gender))", not_typed_msg = "Make sure that you have added the table-command inside the barplot-command.")
test_output_contains("hist(cardiac$age)", not_typed_msg = "Make sure that you have not made any spelling mistakes.")
...
test_function("hist",args=c("main","col"), not_typed_msg = "Did you enter both title and colour options?")
