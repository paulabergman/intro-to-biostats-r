...
# Does this support the alternative hypothesis (on significance level 0.05)? (Answer Y if yes and N if no)
# Your answer: 
```
...
test_student_typed("N", not_typed_msg = "Perhaps you need to check again how to interpret your results.")
