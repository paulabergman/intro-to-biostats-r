...
The t-test is often used to check whether there is differences between two independent groups, quite often men and women, sick and healthy or some other dicotomous groups.
...
The t-test is often used to check whether there is differences between two independent groups, quite often men and women, sick and healthy or some other binary (two classes) groups.
...
# Compare the BMIs by using t-test
...
When dealing with discrete variables, especially binary ones, the test often chosen to check for independence between two of them, is the chi square test.
...
Type print(mydata) on the console and interpret whether there is independence between variables. (significance level 0.05)
