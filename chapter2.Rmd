...
*** =sct
```{r}
test_student_typed("barplot(table(diabetes$gender))", incorrect_msg = "Make sure that you have added the table-command inside the barplot-command.")
test_student_typed("hist(cardiac$age)", incorrect_msg = "Make sure that you have not made any spelling mistakes.")
